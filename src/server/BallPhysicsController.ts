...
export class BallPhysicsController {
    ...
    static unmanage(...ballIDs: Array<string>) {
        ...
        if (indicesToDrop.length > 0) {
            ...
            for (const index of indicesToDrop.reverse()) {
                // It's reversed so we don't have to worry about adjusting any
                // upcoming indices
    ...
    static _serveBall(serverBall: ServerBallInterface, ballID: string) {
    ...
    static _moveBall(clientBall: ClientBallInterface, serverBall: ServerBallInterface) {
    ...
    static _wallBounce(clientBall: ClientBallInterface, 
        ...
        static _executePaddleBounce(clientBall: ClientBallInterface,
            serverBall: ServerBallInterface,
            paddle: Vector) {
        {
